      ...
      <div class="tasks-wrapper">
        ...
        <div class="tasks-list">
          <form action="">
            ...
            <div class="task-box">
              <div class="task">
                <label for="test" class="task-label custom-checkbox">
                  <input type="checkbox" name="test" id="test" /><span
